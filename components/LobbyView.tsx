                    ...
                    >
                      {GENRES.map(g => (
                        <button
                          ...
                          className={`w-full text-left px-4 py-3 text-xs font-mono transition-colors ${gameState.settings.scenarioType === g.id
              ...
              <div className="flex bg-black/50 border border-game-accent/30 rounded-sm p-0.5">
                {['ru', 'en'].map(lang => (
                  <button
                    ...
                    disabled={!canEdit}
                    className={`px-4 py-1.5 text-[10px] font-mono rounded-sm transition-colors ${gameState.settings.storyLanguage === lang
