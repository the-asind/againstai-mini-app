  ...
  return (
    <div className={`markdown-body w-full overflow-hidden ${className}`}>
      <ReactMarkdown
        ...
        components={{
          // Headers
          h1: ({node, ...props}) => <h1 className="text-2xl font-bold text-tg-text mt-6 mb-4 border-b border-tg-hint/20 pb-2 break-words" {...props} />,
          h2: ({node, ...props}) => <h2 className="text-xl font-bold text-tg-text mt-5 mb-3 break-words" {...props} />,
          h3: ({node, ...props}) => <h3 className="text-lg font-bold text-tg-text mt-4 mb-2 uppercase tracking-wide opacity-90 break-words" {...props} />,
          h4: ({node, ...props}) => <h4 className="text-base font-bold text-tg-text mt-3 mb-2 break-words" {...props} />,

          // Text & Paragraphs
          p: ({node, ...props}) => <p className="text-base text-tg-text leading-relaxed mb-4 last:mb-0 break-words" {...props} />,
          ...
          table: ({node, ...props}) => (
            <div className="overflow-x-auto my-6 rounded-lg border border-tg-hint/20">
              <table className="min-w-full divide-y divide-tg-hint/20 text-sm text-left table-auto" {...props} />
            </div>
          ),
