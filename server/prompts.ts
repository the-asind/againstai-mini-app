...
export const SYSTEM_INSTRUCTIONS = {
  SCENARIO_GENERATOR: `
    ...
    - Придумай идеальную, свежую, непопулярную идею реализации жанра, роли и закона угрозы. Прочтение должно нравиться игрокам, как отличная история гейм-мастера.
