...
export const translations = {
  en: {
    ...
    missionDirectives: "MISSION DIRECTIVES",
    environment: "ENVIRONMENT",
    protocol: "PROTOCOL",
    aiCoreIntel: "AI CORE INTEL",
    audio: "AUDIO",
    visuals: "VISUALS",
    storyLanguageOverride: "STORY LANGUAGE OVERRIDE",
    ...
    noKeys: "NO KEYS",
    offline: "OFFLINE",
    awaitingOperatives: "AWAITING OPERATIVES...",
    waitingForCaptain: "WAITING FOR CAPTAIN...",
  ...
  ru: {
    ...
    missionDirectives: "ДИРЕКТИВЫ МИССИИ",
    environment: "ОКРУЖЕНИЕ",
    protocol: "ПРОТОКОЛ",
    aiCoreIntel: "ЯДРО ИИ",
    audio: "АУДИО",
    visuals: "ВИЗУАЛ",
    storyLanguageOverride: "ЯЗЫК ИСТОРИИ",
    activeSquad: "АКТИВНЫЙ ОТРЯД",
    connected: "ПОДКЛЮЧЕНО",
    status: "СТАТУС",
    ready: "ГОТОВ",
    noKeys: "НЕТ КЛЮЧЕЙ",
    offline: "ОФФЛАЙН",
    awaitingOperatives: "ОЖИДАНИЕ ОПЕРАТИВНИКОВ...",
    waitingForCaptain: "ОЖИДАНИЕ КАПИТАНА...",
    initiateProtocol: "ИНИЦИИРОВАТЬ ПРОТОКОЛ",
    linkId: "ID ССЫЛКИ",
